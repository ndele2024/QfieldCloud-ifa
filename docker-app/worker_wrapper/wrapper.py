...
class JobRun:
    ...
    def get_environment(self) -> dict[str, str]:
        ...
        # Variables de connexion pour la validation IFE — lues depuis
        # l'environnement du worker_wrapper (défini dans docker-compose ou
        # comme secrets QFieldCloud) et transmises au conteneur qgis.
        _validation_passthrough = {
            k: os.environ[k]
            for k in [
                "VALIDATION_PG_HOST",
                "VALIDATION_PG_PORT",
